...
// Servo adjustment
#define _DUTY_MAX 2355  // Servo angle: D degree
#define _DUTY_NEU 1800  // Servo angle: 0 degree
#define _DUTY_MIN 929   // Servo angle: E degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 0.00125f * a_value * a_value
        - 1.46f * a_value
        + 463;
}
